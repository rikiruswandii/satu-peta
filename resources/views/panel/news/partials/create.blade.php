                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title text-primary">{{ __('Tambah Artikel') }}</h3>
                            <div class="nk-block-des text-soft">
                                <p class="text-sm">Masukkan form data
                                    <strong class="text-primary">{{ __('artikel') }}</strong> yang ingin Anda simpan.
                                </p>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="title" placeholder="masukkan nama.." value="{{ old('title') }}" required>
                                            @error('title')
